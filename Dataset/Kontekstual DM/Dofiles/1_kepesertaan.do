...
label variable PSTV03     "Tanggal lahir peserta"
label variable PSTV04     "Hubungan Keluarga"
label variable PSTV05     "Jenis Kelamin"
label variable PSTV06     "Status perkawinan"
label variable PSTV07     "Kelas rawat"
label variable PSTV08     "Segmentasi peserta"
label variable PSTV09     "Provinsi Tempat Tinggal Peserta"
label variable PSTV10     "Kabupaten/Kota Tempat Tinggal Peserta"
label variable PSTV11     "Kepemilikan faskes"
label variable PSTV12     "Jenis faskes"
label variable PSTV13     "Provinsi Fasilitas Kesehatan Peserta Terdaftar"
label variable PSTV14     "Kabupaten/Kota Fasilitas Kesehatan Peserta Terdaftar"
label variable PSTV15     "Bobot"
label variable PSTV16     "Tahun Sampel"
label variable PSTV17     "Status Kepesertaan"
label variable PSTV18     "Tahun Meninggal"
...
label define PSTV17    
    ...
    8  "NON AKTIF KARNA PREMI"
    9  "BU LAPSE"
    10  "NON AKTIF DIAKHIR BULAN"
    11  "PENANGGUHAN AKTIVASI PESERTA"
    12  "PENANGGUHAN PEMBAYARAN"
    13  "NON AKTIF KARNA DATA GANDA"
    14  "NON AKTIF KARNA HABIS PERMITS"
    15  "USIA ANAK PPU > 21 TH DAN 25 TH"
    16  "USIA ANAK PPU > 25"
    17  "PPNPN MASA BERLAKU HABIS"
    18  "USIA > 90 TAHUN"
    19  "USIA VETERAN > 85 TAHUN"
    20  "BERADA DI LUAR NEGERI"
    21  "NON AKTIF OLEH PUSAT"
;
    
#delimit cr
    label values  PSTV04 PSTV04
    label values  PSTV05 PSTV05
    label values  PSTV06 PSTV06
    label values  PSTV07 PSTV07
    label values  PSTV08 PSTV08
    label values  PSTV09 PSTV09
    label values  PSTV10 PSTV10
    label values  PSTV11 PSTV11
    label values  PSTV12 PSTV12
    label values  PSTV13 PSTV13
    label values  PSTV14 PSTV14
    label values  PSTV17 PSTV17
